...
class RegisterQuestionVoters extends Command
{
    private $listId = 8; // Brevo list id for question-voters
    private $apiKey;
     ...
     * @var string
     */
    protected $signature = 'app:register-question-voters';
     ...
     * @var string
     */
    protected $description = 'Register question voters on Brevo';
    ...
    public function handle()
    {
        ...
        try {
            ...
            $newContacts = QuestionVoter::all()->unique('email');
            ...
            Log::error('RegisterQuestionVoters: ' . $e->getMessage());
        }
    }
